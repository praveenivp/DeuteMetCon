...
text(bh(3).YEndPoints,bh(3).XEndPoints,lab_csi(1:3),"FontSize",12)

lab_csi=string(strsplit(sprintf('%0.2fx ',(round(sig_bSSFP./sig_fisp,2)))));
text(bh(2).YEndPoints,bh(2).XEndPoints,lab_csi(1:3),"FontSize",12)

lab_csi=string(strsplit(sprintf('%0.2fx ',(round(sig_me./sig_fisp,2)))));
text(bh(1).YEndPoints,bh(1).XEndPoints,lab_csi(1:3),"FontSize",12)
