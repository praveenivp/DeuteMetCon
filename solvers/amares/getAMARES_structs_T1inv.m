...
for i=1:nMet
    ...
    bounds=[bounds,...
        struct("peakName",metabolites(i).name,"chemShift",chemShift(i)+[-1 1]*0.01,"linewidth",[6 30],"amplitude",amplitude(i)*[-Inf Inf],"phase",[0 360],"chemShiftDelta",[],"amplitudeRatio","[]")];
