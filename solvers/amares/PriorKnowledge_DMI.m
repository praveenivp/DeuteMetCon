...
bounds=[bounds,...
    struct("peakName",amares_struct.peakName(i),"chemShift",amares_struct.chemShift(i)+[-1 1]*0.2,"linewidth",[2 25],"amplitude",amares_struct.amplitude(i)*[-0 Inf],"phase",[0 360],"chemShiftDelta",[],"amplitudeRatio","[]")];
