...
bounds=[bounds,...
    struct("peakName",amares_struct.peakName(i),"chemShift",amares_struct.chemShift(i)+[-1 1]*1,"linewidth",[0 10],"amplitude",[-Inf Inf],"phase",[-180 180],"chemShiftDelta",[],"amplitudeRatio","[]")];
