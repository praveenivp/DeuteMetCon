...
function [wsvdCombination, wsvdQuality, wsvdCoilAmplitudes, wsvdWeights, noiseCov] = wsvd(rawSpectra, noiseMask, varargin)
...
%svdRescale =  wsvdCoilAmplitudes(options.phaseRefChannel);
